    ...
    <form action="/user/register" method="post" class="form-horizontal">
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="emailVerify" name="emailVerify" type="text" placeholder="Email verification" class="form-control input-md" required="">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="passwordVerify" name="passwordVerify" type="password" placeholder="Password verification" class="form-control input-md" required="">
