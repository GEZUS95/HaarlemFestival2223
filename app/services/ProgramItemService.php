...
class ProgramItemService
{
    ...
    {
        $this->repository->insertOne($program_id, $location_id, $artist_id, $special_guest_id, $content_id, $start_time, $end_time, $price, $seats_left);
    }
    ...
    {
        $this->repository->updateOne($id, $program_id, $location_id, $artist_id, $special_guest_id, $content_id, $start_time, $end_time, $price, $seats_left);
    }
